...
export interface ApiContactInquiryContactInquiry
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<['Unread', 'Read', 'Responded']> &
...
export interface ApiGalleryItemGalleryItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['Campus', 'Events', 'Graduation', 'Facilities']
    > &
...
export interface ApiNewsArticleNewsArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Articles for the news section';
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<['Event', 'Announcement', 'News']> &
...
export interface ApiNewsletterSubscriberNewsletterSubscriber
  ...
  info: {
    description: 'Subscribers from the footer newsletter form';
